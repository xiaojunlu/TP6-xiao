...
use app\common\exception\FileToolkitException;
...
class FileToolkit
{
     ...
     * @author
     */
    public static function validateFileExtension($file, $extensions = array())
    {
        if (empty($extensions)) {
        ...
        if ($file instanceof File) {
            $filename = $file->getInfo('name'); //think\File 获取上传的文件名
        } else {
    ...
    public static function isIcoFile($file)
    {
